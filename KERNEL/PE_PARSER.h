...
namespace SYSTEM {
	namespace STARTUP {
		...
		namespace PE_PARSER {
			...
			class PePerser {
				[[nodiscard("nodiscarding the return of this function is almost alwas an error since its main purpose is to provide accces to a datamember")]]
				static void*& internals() {
					static void* internals=nullptr;
